...
import (
	...
	"github.com/chnxq/x-utils/geoip/ip2region/xdb"
)
...
// NewIp2Region create a new Ip2Region service with specified v4 and v6 config.
// set it to nil to disable the specified search for the specified version.
